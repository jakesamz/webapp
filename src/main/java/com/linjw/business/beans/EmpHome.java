 ...
 * @see com.linjw.business.beans.Emp
...
public class EmpHome {
	...
	public Emp findById(com.linjw.business.beans.EmpId id) {
		log.debug("getting Emp instance with id: " + id);
		try {
			Emp instance = (Emp) sessionFactory.getCurrentSession().get(
					"com.jake.Emp", id);
			if (instance == null) {
